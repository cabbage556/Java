...
public class ArrayTwoDimension {
    ...
    public void twoDimensionArray() {
        // 2차원 int 배열 선언 및 초기화: 1차원, 2차원 배열 크기 고정
        //      twoDim[0]: int[]
        //      twoDim[0][0]: int 값
        ...
        // 2차원 int 배열 선언 및 초기화: 1차원 배열 크기 고정, 2차원 배열 크기 가변
        int[][] twoDim2 = new int[2][];
        twoDim2[0] = new int[3];  // 2차원 배열의 1번째 배열 크기: 3
        twoDim2[1] = new int[2];  // 2차원 배열의 2번째 배열 크기: 2
